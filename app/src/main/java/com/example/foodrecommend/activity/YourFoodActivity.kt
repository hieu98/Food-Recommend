...
class YourFoodActivity : AppCompatActivity(), YourFoodAdapter.OnItemClickListener {

    private lateinit var mAuth: FirebaseAuth
    private var databaseReference: DatabaseReference? = null
    private var database: FirebaseDatabase? = null

    private lateinit var danhsachAdapter: YourFoodAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list = ArrayList()
        listRate = ArrayList()
        danhsachAdapter = YourFoodAdapter(this, list, listRate, this)
